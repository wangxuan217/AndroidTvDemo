...
public class FocusGridLayoutManager extends GridLayoutManager
{
    ...
    /**
     * Constructor used when layout manager is set in XML by RecyclerView attribute "layoutManager". If spanCount is not
     * specified in the XML, it defaults to a single column.
     *
     * @param context
     * @param attrs
     * @param defStyleAttr
     ...
     * RecyclerView. This is the LayoutManager's opportunity to populate views in the given direction to fulfill the
     * request if it can. The LayoutManager should attach and return the view to be focused. The default implementation
     * returns null. 防止当recyclerview上下滚动的时候焦点乱跳
     * 
     * @param focused
