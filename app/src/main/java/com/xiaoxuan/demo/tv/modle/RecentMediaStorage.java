package com.xiaoxuan.demo.tv.modle;
...
public class RecentMediaStorage
{
    ...
    public static final String ALL_COLUMNS[] = new String[] {Entry.COLUMN_NAME_ID + " as _id", Entry.COLUMN_NAME_ID,
        Entry.COLUMN_NAME_URL, Entry.COLUMN_NAME_NAME, Entry.COLUMN_NAME_LAST_ACCESS};
    ...
    public static class OpenHelper extends SQLiteOpenHelper
    {
        ...
        private static final String SQL_CREATE_ENTRIES =
            " CREATE TABLE IF NOT EXISTS " + Entry.TABLE_NAME + " (" + Entry.COLUMN_NAME_ID
                + " INTEGER PRIMARY KEY AUTOINCREMENT, " + Entry.COLUMN_NAME_URL + " VARCHAR UNIQUE, "
                + Entry.COLUMN_NAME_NAME + " VARCHAR, " + Entry.COLUMN_NAME_LAST_ACCESS + " INTEGER) ";
